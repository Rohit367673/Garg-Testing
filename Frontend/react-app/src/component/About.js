...
const About = () => {
  const brandLogos = [
    ...
    "/Images/Unknown.jpeg",
    "/Images/images.jpeg"
    // Add paths to brand logo images here
  ];
    ...
    <div className="about-page">
      <section className="hero-section">
        <div className="hero-content">
          ...
          <p className="animated-subtitle">
            Discover a world of achievements and multi-brand availability under
            one roof!
          </p>
        </div>
      </section>
     ...
     <div className="promotion-container mt-28">
      ...
      <div className="P-left-content">
        ...
        <p> Our achievements and initiatives have been featured in 
           media outlets.</p>
        <ul>
